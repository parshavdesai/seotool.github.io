                 ...
                 <div class="box-header"> <br />
                    <h3 class="box-title">License Verification</h3>
                        ...
                        <div class="form-group">
                            ...
                            <input value="codexinh" style="border-color: #DDDDDD;" type="text" placeholder="Enter 'codexinh.com' for item purchase code" name="data_sec" id="data_sec" class="form-control">
                        </div>
                    </div><!-- /.box-body -->
    ...
    <br />  
     ...
     <!-- Main Footer -->
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2018 <a href="http://prothemes.biz/">ProThemes.Biz</a></strong> All rights reserved.
      </footer>
